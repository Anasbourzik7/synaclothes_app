...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading 
        ? const Center(child: CircularProgressIndicator()) // Afficher un indicateur de chargement si _isLoading est true
        : Padding(
            padding: const EdgeInsets.all(16.0), // Espacement autour des champs
            child: Form(
              ...
              child: ListView(
                children: [
                  ...
                  TextFormField(
                    ...
                    inputFormatters: [FilteringTextInputFormatter.digitsOnly], // seulement les chiffres
